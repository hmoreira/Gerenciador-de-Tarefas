    ...
    {        
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            if (!users.Any())
                ...
                return Ok(_mapper.Map<List<UserPutGet>>(_mapper.Map<List<Usuario>>(users)));            
        }
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody]UserPut usuario)
        {
            if (!IsAdmin())
            ...
            try
            {
                Infrastructure.Models.Usuario model = new Infrastructure.Models.Usuario();
                model.Nome = usuario.Nome;
                model.Id = usuario.Id;
                model.Funcao = usuario.Funcao;
        ...
        public async Task<IActionResult> Login([FromBody]UserLogin login)
        {
            ...
            {
                var user = _mapper.Map<UserPutGet>(_mapper.Map<Usuario>(ret));
